...
Since stock prices are dynamic and change frequently, the underlying options, and therefore their “Greeks”, are also dynamic and change frequently. Because of this, market makers must also adjust their deltas. The most common form of adjusting deltas is referred to as “Gamma Hedging.” As discussed previously, gamma is the change in delta per change in underlying equity price. As the underlying equity price moves, market makers or dealers will adjust their deltas according to gamma. This means they are buying or selling additional shares depending upon the price movements. As you can imagine, this exacerbates the "momentum" in the equity. It is this process that has led to extreme moves in equities such as Gamestop (GME) and AMC in 2021. 
